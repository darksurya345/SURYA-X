...
console.log(`SURYA-X ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+917797099719'; // Replace this with the actual owner number
        const ownerName = 'DARK SURYA'; // Replace this with the owner's name
        const organization = 'SURYA-X CODERS'; // Optional: replace with the owner's organization
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+917797099719', '') + '+917797099719@s.whatsapp.net'], // Mention the owner
...
try{
let dec = `> SURYA-X REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ SURYA-X REPO: ${bot.REPO_LINK} 
┃
