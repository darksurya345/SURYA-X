...
const sessdata = config.SESSION_ID.replace("SURYA-X~", '');
...
console.log("CONNECTING SURYA-X 🧬...");
...
console.log('SURYA-X CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ SURYA-X ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ SURYA ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs 

*https://whatsapp.com/channel/0029VbBvVG8AYlUCU47u4W1t*
...
if(senderNumber.includes("917797099719")){
if(isReact) return
m.react("🦋")
   }
